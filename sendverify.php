...
if (mysqli_connect_errno()) {
    ...
    $sql = "INSERT INTO `verify` (`ID`, `BAHA_ID`, `BAHA_HASH`, `TIME`, `EXPIRE_TIME`, `IP`, `verifycomplete`) VALUES (NULL, '" . mysqli_real_escape_string($con,$Name) . "', '" . mysqli_real_escape_string($con,$Hash) . "', '" . mysqli_real_escape_string($con,$Time) . "', '" . mysqli_real_escape_string($con,$Exp) . "', '" . mysqli_real_escape_string($con,$IP) . "', '0');";
